# Generated by Django 3.2.7 on 2022-08-13 19:53
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='Original',
            fields=[
                ('id_original', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            name='Resultados',
            fields=[
                ('id_resultado', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('original', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='original', to='myapp.document')),
                ('resultados', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='resultados', to='myapp.document')),
            ],
        ),
    ]
